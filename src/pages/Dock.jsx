      ...
      <div className="lg:visible invisible">
        <ul className="grid grid-cols-1 gap-8 pl-8 top-[15rem] fixed left-0 ">
          <Link
            ...
            className="hover:text-yellow-300 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-200"
            target="_blank"
          >
            <li>
              <GitHub />
          ...
          <Link
            href="https://twitter.com/xmayuk_hx"
          ...
          <Link
            href="https://www.instagram.com/xmayuk_hx/"
            className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-200"
            target="_blank"
          >
            <li>
